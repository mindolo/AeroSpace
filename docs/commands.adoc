...
== bsp-presel
----
include::aerospace-bsp-presel.adoc[tags=synopsis]
----
include::aerospace-bsp-presel.adoc[tags=purpose]
include::aerospace-bsp-presel.adoc[tags=body]
...
== flip-node
----
include::aerospace-flip-node.adoc[tags=synopsis]
----
include::aerospace-flip-node.adoc[tags=purpose]
include::aerospace-flip-node.adoc[tags=body]
...
== rebalance-bsp
----
include::aerospace-rebalance-bsp.adoc[tags=synopsis]
----
include::aerospace-rebalance-bsp.adoc[tags=purpose]
include::aerospace-rebalance-bsp.adoc[tags=body]
...
== rotate-node
----
include::aerospace-rotate-node.adoc[tags=synopsis]
----
include::aerospace-rotate-node.adoc[tags=purpose]
include::aerospace-rotate-node.adoc[tags=body]
