...
* Enable BSP (binary space partitioning) mode: `bsp`
...
* Enable BSP mode (rebalances the workspace tree): +
`aerospace layout bsp`

* Toggle between BSP and tiles layouts: +
`aerospace layout bsp tiles`
